...
const CatalogPage = () => {
  ...
  const project_1 = products.find((p) => p.id === 151);
  const project_2 = products.find((p) => p.id === 152);
  const project_3 = products.find((p) => p.id === 153);
  const project_4 = products.find((p) => p.id === 154);
  const project_5 = products.find((p) => p.id === 155);
  const project_6 = products.find((p) => p.id === 156);
  const project_7 = products.find((p) => p.id === 157);
  const project_8 = products.find((p) => p.id === 158);
  const project_9 = products.find((p) => p.id === 159);
  const project_10 = products.find((p) => p.id === 160);
  return (
